...
export const SOCIAL_LINKS = [
  { name: 'GitHub', href: 'https://github.com/HugoAlvarezAjenjo', icon: 'github' },
  { name: 'LinkedIn', href: 'https://www.linkedin.com/in/hugo-alvarez-ajenjo/', icon: 'linkedin' },
  { name: 'Stack Overflow', href: 'https://stackoverflow.com/users/22522941', icon: 'stackoverflow' },
];
